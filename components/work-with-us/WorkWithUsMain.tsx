  ...
  return (
    <div className='flex flex-col justify-center'>
          ...
          <div>
            ...
            <h1 className='text-xl font-bold dark:text-white text-center mt-20'>
              WHY WORK WITH US?
            </h1>
            ...
            <div className='flex flex-col flex-wrap sm:flex-row lg:flex-nowrap w-full justify-center gap-6 lg:gap-8 mb-6 mx-auto p-6 mt-10'>
          ...
          <div className="flex justify-center w-full">
            <Button className="text-center mx-auto text-white" variant='default' size="lg" asChild>
